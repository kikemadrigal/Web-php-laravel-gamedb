...
class GameUserRepository{
    ...
    /**
     * Esta función aparece en views/game/showUser
     */
    public static function getAllGamesByUserAndSystem($user, $system, $start, $end){
        $games=array();
        $basededatos= new MysqliClient();
        $basededatos->conectar_mysql();
    ...
    public static function getGameByUser($user, $idGame){
        $game=null;
        $basededatos= new MysqliClient();
        $basededatos->conectar_mysql();
    ...
    /**
     * Esta función aparece en views/game/search.php
     */
    public static function getSearchGameUserByTitle($search,$idUser){
        $games=array();
        $basededatos= new MysqliClient();
        $basededatos->conectar_mysql();
    ...
    /**
     * Esta función aparece en views/game/showUser.php
     */
    public static function getGameUserByTitle($idUser, $start, $end){
        $games=array();
        $basededatos= new MysqliClient();
        $basededatos->conectar_mysql();
    ...
    /**
    * Esta función es utilizada en views/games/updateUser.php
    */
    public static function getAllGamesByUserAndPublisher($idUser, $publisher, $start, $end){
        $games=array();
        $basededatos= new MysqliClient();
        $basededatos->conectar_mysql();
        $consulta  = "SELECT * FROM gamesUsers WHERE user='".$idUser."' AND publisher='".$publisher."' ORDER BY title LIMIT ".$start .", ".$end." ";
        $resultado=$basededatos->ejecutar_sql($consulta);
        while ($linea = mysqli_fetch_array($resultado)) 
        {
            $game=new Game($linea['id']);
